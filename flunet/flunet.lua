...
local ClosureBindings = {
    function()
        ...
        function Library:CreateWindow(Config)
            ...
            Config.Theme = Config.Theme or "Midnight Sapphire"
        ...
        function Library:Destroy()
            if Library.Window then
                ...
                Creator.Disconnect()
                Library.GUI:Destroy()
                game.CoreGui:FindFirstChild("Mercury Mobile"):Destroy()
            end
        end
    ...
    [9] = function()
        ...
        return function(Theme, Parent, DialogCheck)
            ...
            local Motor, SetTransparency =
                Creator.SpringMotor(1, Button.HoverFrame, "BackgroundTransparency", DialogCheck)
            Creator.AddSignal(
    ...
    [10] = function()
        ...
        function Dialog:Create()
            ...
            local TintMotor, TintTransparency =
                Creator.SpringMotor(1, NewDialog.TintFrame, "BackgroundTransparency", true)
                ...
                for _, Btn in next, NewDialog.ButtonHolder:GetChildren() do
                    if Btn:IsA("TextButton") then
                        Btn.Size =
                            UDim2.new(
                            1 / NewDialog.Buttons,
                            -(((NewDialog.Buttons - 1) * 10) / NewDialog.Buttons),
                            0,
                            32
                        )
                    end
    ...
    [17] = function()
        ...
        return function(Config)
            ...
            Window.TitleBar =
                require(script.Parent.TitleBar)(
                {
                    Title = Config.Title,
                    SubTitle = Config.SubTitle,
                    Parent = Window.Root,
            ...
            Creator.AddSignal(
                ...
                function()
                    Window.TabHolder.CanvasSize =
                        UDim2.new(0, 0, 0, Window.TabHolder.UIListLayout.AbsoluteContentSize.Y)
                end
            )
        ...
        function Element:New(Idx, Config)
            ...
            local function RecalculateListPosition()
                ...
                if Camera.ViewportSize.Y - DropdownInner.AbsolutePosition.Y < DropdownHolderCanvas.AbsoluteSize.Y - 5 then
                    Add =
                        DropdownHolderCanvas.AbsoluteSize.Y - 5 -
            ...
            local function RecalculateListSize()
                if #Dropdown.Values > 10 then
                    ...
                    DropdownHolderCanvas.Size =
                        UDim2.fromOffset(ListSizeX, DropdownListLayout.AbsoluteContentSize.Y + 10)
                end
            end
            ...
            function Dropdown:BuildDropdownList()
                ...
                for Idx, Value in next, Values do
                    ...
                    local SelMotor, SetSelTransparency =
                        Creator.SpringMotor(1, ButtonSelector, "BackgroundTransparency")
    ...
    [28] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(28)
    ...
    [49] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(49)
        return {
            Name = "Aqua",
    ...
    [50] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(50)
        return {
            Name = "Dark",
    ...
    [51] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(51)
        return {
            Name = "Darker",
            Accent = Color3.fromRGB(66, 175, 225),
    ...
    [52] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(52)
        return {
            Name = "Light",
    ...
    [53] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(53)
        return {
            Name = "Rose",
    ...
    [54] = function()
        ...
        return {
            ...
            Accent = Color3.fromRGB(45, 82, 155),
            AcrylicMain = Color3.fromRGB(15, 18, 25),
            AcrylicBorder = Color3.fromRGB(55, 75, 115),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 65, 120), Color3.fromRGB(20, 30, 55)),
            AcrylicNoise = 0.94,
            TitleBarLine = Color3.fromRGB(60, 80, 120),
            Tab = Color3.fromRGB(70, 95, 140),
            Element = Color3.fromRGB(55, 75, 120),
            ElementBorder = Color3.fromRGB(35, 45, 70),
            InElementBorder = Color3.fromRGB(50, 65, 95),
            ElementTransparency = 0.89,
            ToggleSlider = Color3.fromRGB(60, 85, 135),
            ToggleToggled = Color3.fromRGB(15, 18, 25),
            SliderRail = Color3.fromRGB(60, 85, 135),
            DropdownFrame = Color3.fromRGB(75, 100, 150),
            DropdownHolder = Color3.fromRGB(25, 35, 55),
            DropdownBorder = Color3.fromRGB(30, 40, 65),
            DropdownOption = Color3.fromRGB(55, 75, 120),
            Keybind = Color3.fromRGB(55, 75, 120),
            Input = Color3.fromRGB(55, 75, 120),
            InputFocused = Color3.fromRGB(15, 20, 35),
            InputIndicator = Color3.fromRGB(80, 105, 155),
            Dialog = Color3.fromRGB(25, 35, 55),
            DialogHolder = Color3.fromRGB(20, 25, 40),
            DialogHolderLine = Color3.fromRGB(15, 20, 35),
            DialogButton = Color3.fromRGB(25, 35, 55),
            DialogButtonBorder = Color3.fromRGB(45, 60, 90),
            DialogBorder = Color3.fromRGB(40, 55, 85),
            DialogInput = Color3.fromRGB(30, 40, 65),
            DialogInputLine = Color3.fromRGB(85, 110, 160),
            Text = Color3.fromRGB(220, 225, 235),
            SubText = Color3.fromRGB(160, 170, 190),
            Hover = Color3.fromRGB(55, 75, 120),
            HoverChange = 0.05
        }
    end,
    [55] = function()
        ...
        return {
            Name = "Deep Ocean",
            Accent = Color3.fromRGB(0, 145, 189),
            AcrylicMain = Color3.fromRGB(10, 15, 25),
            AcrylicBorder = Color3.fromRGB(30, 85, 125),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 95, 145), Color3.fromRGB(10, 45, 75)),
            AcrylicNoise = 0.93,
            TitleBarLine = Color3.fromRGB(40, 95, 135),
            Tab = Color3.fromRGB(50, 120, 160),
            Element = Color3.fromRGB(40, 110, 150),
            ElementBorder = Color3.fromRGB(25, 60, 90),
            InElementBorder = Color3.fromRGB(35, 75, 105),
            ElementTransparency = 0.88,
            ToggleSlider = Color3.fromRGB(45, 115, 155),
            ToggleToggled = Color3.fromRGB(10, 15, 25),
            SliderRail = Color3.fromRGB(45, 115, 155),
            DropdownFrame = Color3.fromRGB(55, 125, 165),
            DropdownHolder = Color3.fromRGB(20, 45, 70),
            DropdownBorder = Color3.fromRGB(25, 55, 85),
            DropdownOption = Color3.fromRGB(40, 110, 150),
            Keybind = Color3.fromRGB(40, 110, 150),
            Input = Color3.fromRGB(40, 110, 150),
            InputFocused = Color3.fromRGB(15, 25, 40),
            InputIndicator = Color3.fromRGB(60, 130, 170),
            Dialog = Color3.fromRGB(20, 45, 70),
            DialogHolder = Color3.fromRGB(15, 35, 55),
            DialogHolderLine = Color3.fromRGB(10, 30, 50),
            DialogButton = Color3.fromRGB(20, 45, 70),
            DialogButtonBorder = Color3.fromRGB(35, 80, 110),
            DialogBorder = Color3.fromRGB(30, 75, 105),
            DialogInput = Color3.fromRGB(25, 50, 75),
            DialogInputLine = Color3.fromRGB(65, 135, 175),
            Text = Color3.fromRGB(225, 235, 245),
            SubText = Color3.fromRGB(165, 185, 205),
            Hover = Color3.fromRGB(40, 110, 150),
            HoverChange = 0.05
        }
    end,
    [56] = function()
        ...
        return {
            Name = "Royal Purple",
            Accent = Color3.fromRGB(147, 45, 255),
            AcrylicMain = Color3.fromRGB(18, 12, 25),
            AcrylicBorder = Color3.fromRGB(95, 55, 145),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(105, 45, 185), Color3.fromRGB(45, 25, 85)),
            AcrylicNoise = 0.92,
            TitleBarLine = Color3.fromRGB(105, 65, 155),
            Tab = Color3.fromRGB(125, 80, 180),
            Element = Color3.fromRGB(115, 70, 170),
            ElementBorder = Color3.fromRGB(65, 40, 95),
            InElementBorder = Color3.fromRGB(80, 50, 115),
            ElementTransparency = 0.87,
            ToggleSlider = Color3.fromRGB(120, 75, 175),
            ToggleToggled = Color3.fromRGB(18, 12, 25),
            SliderRail = Color3.fromRGB(120, 75, 175),
            DropdownFrame = Color3.fromRGB(135, 85, 185),
            DropdownHolder = Color3.fromRGB(45, 30, 70),
            DropdownBorder = Color3.fromRGB(55, 35, 85),
            DropdownOption = Color3.fromRGB(115, 70, 170),
            Keybind = Color3.fromRGB(115, 70, 170),
            Input = Color3.fromRGB(115, 70, 170),
            InputFocused = Color3.fromRGB(25, 15, 40),
            InputIndicator = Color3.fromRGB(140, 90, 190),
            Dialog = Color3.fromRGB(45, 30, 70),
            DialogHolder = Color3.fromRGB(35, 20, 55),
            DialogHolderLine = Color3.fromRGB(30, 15, 50),
            DialogButton = Color3.fromRGB(45, 30, 70),
            DialogButtonBorder = Color3.fromRGB(85, 55, 115),
            DialogBorder = Color3.fromRGB(75, 50, 110),
            DialogInput = Color3.fromRGB(50, 35, 75),
            DialogInputLine = Color3.fromRGB(145, 95, 195),
            Text = Color3.fromRGB(235, 225, 245),
            SubText = Color3.fromRGB(185, 165, 205),
            Hover = Color3.fromRGB(115, 70, 170),
            HoverChange = 0.06
        }
    end,
    [57] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(57)
        return {
            Name = "Emerald Night",
            Accent = Color3.fromRGB(45, 185, 115),
            AcrylicMain = Color3.fromRGB(12, 20, 15),
            AcrylicBorder = Color3.fromRGB(55, 115, 85),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(45, 145, 95), Color3.fromRGB(25, 65, 45)),
            AcrylicNoise = 0.91,
            TitleBarLine = Color3.fromRGB(65, 125, 95),
            Tab = Color3.fromRGB(80, 145, 110),
            Element = Color3.fromRGB(70, 135, 100),
            ElementBorder = Color3.fromRGB(40, 75, 55),
            InElementBorder = Color3.fromRGB(50, 95, 70),
            ElementTransparency = 0.86,
            ToggleSlider = Color3.fromRGB(75, 140, 105),
            ToggleToggled = Color3.fromRGB(12, 20, 15),
            SliderRail = Color3.fromRGB(75, 140, 105),
            DropdownFrame = Color3.fromRGB(85, 150, 115),
            DropdownHolder = Color3.fromRGB(30, 55, 40),
            DropdownBorder = Color3.fromRGB(35, 65, 45),
            DropdownOption = Color3.fromRGB(70, 135, 100),
            Keybind = Color3.fromRGB(70, 135, 100),
            Input = Color3.fromRGB(70, 135, 100),
            InputFocused = Color3.fromRGB(15, 30, 20),
            InputIndicator = Color3.fromRGB(90, 155, 120),
            Dialog = Color3.fromRGB(30, 55, 40),
            DialogHolder = Color3.fromRGB(20, 40, 30),
            DialogHolderLine = Color3.fromRGB(15, 35, 25),
            DialogButton = Color3.fromRGB(30, 55, 40),
            DialogButtonBorder = Color3.fromRGB(55, 95, 75),
            DialogBorder = Color3.fromRGB(50, 90, 70),
            DialogInput = Color3.fromRGB(35, 60, 45),
            DialogInputLine = Color3.fromRGB(95, 160, 125),
            Text = Color3.fromRGB(225, 245, 235),
            SubText = Color3.fromRGB(165, 205, 185),
            Hover = Color3.fromRGB(70, 135, 100),
            HoverChange = 0.05
        }
    end,
    [58] = function()
        local maui, script, require, getfenv, setfenv = ImportGlobals(58)
        return {
            Name = "Crimson Dark",
            Accent = Color3.fromRGB(205, 45, 65),
            AcrylicMain = Color3.fromRGB(20, 12, 15),
            AcrylicBorder = Color3.fromRGB(125, 55, 65),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(155, 45, 55), Color3.fromRGB(75, 25, 35)),
            AcrylicNoise = 0.93,
            TitleBarLine = Color3.fromRGB(135, 65, 75),
            Tab = Color3.fromRGB(155, 80, 90),
            Element = Color3.fromRGB(145, 70, 80),
            ElementBorder = Color3.fromRGB(85, 40, 45),
            InElementBorder = Color3.fromRGB(105, 50, 55),
            ElementTransparency = 0.88,
            ToggleSlider = Color3.fromRGB(150, 75, 85),
            ToggleToggled = Color3.fromRGB(20, 12, 15),
            SliderRail = Color3.fromRGB(150, 75, 85),
            DropdownFrame = Color3.fromRGB(165, 85, 95),
            DropdownHolder = Color3.fromRGB(65, 30, 35),
            DropdownBorder = Color3.fromRGB(75, 35, 40),
            DropdownOption = Color3.fromRGB(145, 70, 80),
            Keybind = Color3.fromRGB(145, 70, 80),
            Input = Color3.fromRGB(145, 70, 80),
            InputFocused = Color3.fromRGB(30, 15, 20),
            InputIndicator = Color3.fromRGB(170, 90, 100),
            Dialog = Color3.fromRGB(65, 30, 35),
            DialogHolder = Color3.fromRGB(50, 20, 25),
            DialogHolderLine = Color3.fromRGB(45, 15, 20),
            DialogButton = Color3.fromRGB(65, 30, 35),
            DialogButtonBorder = Color3.fromRGB(105, 55, 60),
            DialogBorder = Color3.fromRGB(95, 50, 55),
            DialogInput = Color3.fromRGB(70, 35, 40),
            DialogInputLine = Color3.fromRGB(175, 95, 105),
            Text = Color3.fromRGB(245, 225, 230),
            SubText = Color3.fromRGB(205, 165, 175),
            Hover = Color3.fromRGB(145, 70, 80),
            HoverChange = 0.06
        }
    end
} -- [RefId] = Closure
